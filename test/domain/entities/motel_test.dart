...
//   });
//
//   test('Classe Motel deve poder ser instancado com os valores mockados da api', (){
...
main() {
  ...
  test('Classe Motel deve poder ser instancada com os valores da api', (){
    ...
    expect(motel.runtimeType == Motel, true);
    expect(motel.name == "Motel Le Nid", true);
    expect(motel.logo == "https://cdn.guiademoteis.com.br/imagens/logotipos/3148-le-nid.gif", true);
    expect(motel.neighborhood == "Chácara Flora - São Paulo", true);
    expect(motel.suites[0].name == "Suíte Marselha s/ garagem privativa", true);
    expect(motel.suites[0].categoryItens[0].name == "Frigobar", true);
    expect(motel.suites[0].periods[0].formattedTime == "3 horas", true);
    expect(motel.suites[0].periods[0].value == 88.0, true);
    expect(motel.numberOfReviews == 2159, true);
    expect(motel.media == 4.6, true);
