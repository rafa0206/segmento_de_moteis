...
void main() {
  ...
  group('MotelApi', () {
    test('retornar uma lista de moteis quando a requisicao funcionar', () async {
      final jsonResponse = encoder.convert(
        {
          "sucesso": true,
          "data": {
            "pagina": 1,
      ...
      when(mockHttpClient.get(Uri.parse('https://www.jsonkeeper.com/b/1IXK')))
          .thenAnswer((_) async => http.Response(jsonResponse, 200));

      var motels = await motelApi.getMotels();
    ...
    test('deve retornar null quando a requisicao falhar', () async {
      when(mockHttpClient.get(Uri.parse('https://www.jsonkeeper.com/b/1IXK')))
          .thenAnswer((_) async => http.Response('Error', 500));

      var motels = await motelApi.getMotels();

      expect(motels, isNull);
    });
